...
## What I learned
Staging allows selective file tracking before committing changes. Commits save local snapshots, while remote repositories enable synchronization and collaboration.